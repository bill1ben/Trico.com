...
mon but et de faire en sorte à chaque fois quand je cherche à sauvegarder une entité de type product (l'entitè t-shirt) il faut que elle-même se prendre en main et vérifie si elle a un Slug . si elle ne l'a pas alors elle va le créer.
